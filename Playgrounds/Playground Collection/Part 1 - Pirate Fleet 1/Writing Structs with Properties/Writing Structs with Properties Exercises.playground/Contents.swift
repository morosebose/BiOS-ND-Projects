...
*/
var rawls = Author(firstName: "Wilson", lastName: "Rawls", living: false)
var redfern = Book(title: "Where the Red Fern Grows", author: rawls, pages: 245, numberOfStars: 4.0, description: "About a young boy and his hunting dogs", genre: "Children's Books")

var tolkien = Author(firstName: "John Ronald Reuel", lastName: "Tolkien", living: false)
var hobbit = Book(title: "The Hobbit", author: tolkien, pages: 300, numberOfStars: 4.5, description: "follows the treasure-seeking quest of hobbit Bilbo", genre: "fantasy")
